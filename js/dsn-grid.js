    ...
    isMobile: function () {
        ...
        if (e = this.convertToJQuery(e), t = t || e, t = this.convertToJQuery(t), !(0 < e.find(".dsn-word-wrapper").length)) {
            ...
            try {
                for (var c, u = o[Symbol.iterator](); !(s = (c = u.next()).done); s = !0) {
                    var f = c.value;
                    if (0 !== f.length) {
                        if (i += '<div class="dsn-word-wrapper" style="position: relative;display: inline-block;--word-dsn-index:' + r + ';">', n) for (var v = 0; v < f.length; v++) i += '<span class="dsn-chars-wrapper" style="position: relative;display: contents;--char-dsn-index:' + a + ';">' + f.charAt(v) + "</span>", a++; else i += f;
        ...
        return {
            addParrlax: function (e) {
                ...
                var t = a.convertToJQuery(e.id), n = new ScrollMagic.Scene({
        ...
        return o instanceof jQuery == !1 && (o = jQuery(o)), r = this.getUndefinedVal(r, {}), e = this.getUndefinedVal(r.sizeX, "105%"), t = this.getUndefinedVal(r.sizeY, "105%"), n = this.getUndefinedVal(r.left, "-5%"), s = this.getUndefinedVal(r.top, "-5%"), a = this.getUndefinedVal(r.move, 100), o.css({
            ...
            var t = e.clientX / jQuery(this).width() - .5, n = e.clientY / jQuery(this).height() - .5;
        ...
        var o = $('[data-dsn-grid="progress-circle"]'), t = this.removeAttr(o, "data-dsn-grid-stroke"),
            n = void 0 === t ? "" : 'stroke="' + t + '"';
        o.css({
            position: "fixed",
            right: "-60px",
        ...
        e.isScroller(!0) && (i = e.getScrollbar()), e.getListener(function (e) {
            var t = 0, n = $(document).height() - wind.height();
